...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        for item in items {
            ...
            pictures.sort()
            //sorting the pictures so they listed on the app in crescent order
    ...
    @objc func recommendTapped(){
        let recommendThisApp = "Download Storm Viewer from the App Store! It's awesome!"
        
        let vc = UIActivityViewController(activityItems: [recommendThisApp], applicationActivities: [])
